...
const DEFAULT_TAX_RATE = 0.0125; // 1.25% generic tax rates
...
const App = (props) => {
    ...
    // user inputs
    const [downPaymentPercent, setDownPaymentPercent] = useState(props.down_payment_percent);
    const [interestRate, setInterestRate] = useState(props.interest_rate);
    const [loanTerm, setLoanTerm] = useState(props.loan_terms);
    const [insuranceYearly, setInsuranceYearly] = useState(props.yearly_insurance);
    ...
    */
    ...
    return ( <
        ...
        <
        div className = "bg-white shadow-2xl p-6 md:p-10 w-full max-w-6xl flex flex-col lg:flex-row gap-8 lg:gap-12 transition-all duration-300" >
        <
        CalculatorView selectedUnit = { selectedUnit }
